                            ...
                            <div class="panel ">
                                <div class="panel-heading">
                                    <h4 class="pull-left"> 
                                                                ...
                                                                jQuery(function () {
                                                                    window.setInterval(function () {
                                                                        ...
                                                                        $.post('lib/shout.php', load_group_admin_notifications, function (grp_admin_data) {
                                                                            ...
                                                                            $('#total_admin_count').html(ttl_group_admin + "&nbsp;People");
                                        ...
                                        <!--Membership Blocked <span class="label label-danger" id="total_members_blocked">
												<script>
                                                    jQuery(function () {
                                                        window.setInterval(function () {
                                                            var group_id = '<?php //echo $_GET['group_id']; ?>';
                                                            ...
                                                            $.post('lib/shout.php', load_group_rqst_notifications, function (grp_mem_rqst) {
                                                                ...
                                                                $('#total_members_blocked').html(ttl_group_mem_blocked + "&nbsp;People");
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="fiend-list-content">
                                        ...
                                        <div id="default-feed" class="row">
                                            <?php
                                            include('lib/group-admin-total-list.php');
                                            ?>
                                        </div>
