...
*}
        <div id="search">
            <div class="wrapper">
		<script type="text/javascript" src="themes/Suite7/js/scripts.js"></script>
                <form name='UnifiedSearch' action='index.php' onsubmit='return SUGAR.unifiedSearchAdvanced.checkUsaAdvanced()'>
                    ...
                    <input type="text" name="query_string" id="query_string" value="" onkeyup="autocomplet()" autocomplete="off"/>
                    <ul id="query_string_list"></ul>
                    </div>
