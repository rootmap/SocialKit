                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="photo-content" style="clear:both;" class="row">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <ul id="photo-grid" class="photo-grid list-unstyled no-padding">
                                                <?php
                                                $sqlphoto = $obj->FlyQuery("SELECT alluser_photo.*,p.photo,p.id FROM
                                                                            (select A.p_id, A.pp_id, A.cp_id,
                                                                             ...
                                                                             (
                                                                                ...
                                                                                dpp.photo_id as pp_id, dcp.photo_id as cp_id
                                                                                from  dostums_post as dp
                                                                                left join dostums_profile_photo  as dpp on dp.photo_id = dpp.photo_id
                                                                                left join dostums_cover_photo as dcp on dp.photo_id = dcp.photo_id
                                                                                where dp.user_id='".$new_user_id."' and (dp.status = 2 or dp.status = 3)  and dp.photo_id != 0
                                                                                AND dp.group_id='0' AND dp.page_id='0') A
                                                                            ) as alluser_photo
                                                                            LEFT JOIN dostums_photo as p on p.id=alluser_photo.photo_id
                                                                            WHERE alluser_photo.photo_id!=0 ");
