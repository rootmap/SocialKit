...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2015 at 01:55 PM
...
--
-- Table structure for table `block_friend_user`
--

CREATE TABLE IF NOT EXISTS `block_friend_user` (
  `id` int(20) NOT NULL,
  `user_id` int(20) DEFAULT NULL,
  `block_user_id` int(20) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `status` int(2) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `block_friend_user`
--

INSERT INTO `block_friend_user` (`id`, `user_id`, `block_user_id`, `date`, `status`) VALUES
(1, 4, 5, '2015-12-14', 1),
(2, 12340, 258741, '2015-12-14', 1),
(3, 963258, 741258, '2015-12-14', 1),
(4, 951236, 159847, '2015-12-14', 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `block_friend_user_view`
--
CREATE TABLE IF NOT EXISTS `block_friend_user_view` (
`id` int(20)
,`user_id` int(20)
,`block_user_id` int(20)
,`date` date
,`status` int(2)
);
...
--
-- Table structure for table `block_post_comment`
--

CREATE TABLE IF NOT EXISTS `block_post_comment` (
  `id` int(20) NOT NULL,
...
--
-- Dumping data for table `block_post_comment`
--

INSERT INTO `block_post_comment` (`id`, `post_id`, `comment_id`, `user_id`, `date`, `status`) VALUES
(1, 1, 2, 3, '2015-12-14', 1),
(2, 87, 89, 56, '2015-12-14', 1),
(3, 2147483647, 44444444, 77777777, '2015-12-14', 1),
(4, 45321, 1258, 78592, '2015-12-14', 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `block_post_comment_view`
--
CREATE TABLE IF NOT EXISTS `block_post_comment_view` (
`id` int(20)
,`post_id` int(20)
,`comment_id` int(20)
,`user_id` int(20)
...
--
-- Table structure for table `block_post_user`
--

CREATE TABLE IF NOT EXISTS `block_post_user` (
  `id` int(20) NOT NULL,
  `post_id` int(20) DEFAULT NULL,
  `user_id` int(20) DEFAULT NULL,
  `block_user_id` int(20) DEFAULT NULL,
...
--
-- Dumping data for table `block_post_user`
--

INSERT INTO `block_post_user` (`id`, `post_id`, `user_id`, `block_user_id`, `date`, `status`) VALUES
(1, 1, 2, 3, '2015-12-14', 1),
(2, 1, 2, 3, '2015-12-14', 1),
(3, 45, 56, 23, '2015-12-14', 1),
(4, 7889456, 44442556, 123456, '2015-12-14', 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `block_post_user_view`
--
CREATE TABLE IF NOT EXISTS `block_post_user_view` (
`id` int(20)
,`post_id` int(20)
,`user_id` int(20)
,`block_user_id` int(20)
...
(91, 27, 'name', '2015-12-08', 1),
(94, 29, 'name', '2015-12-08', 1),
(95, 29, 'page_type_id', '2015-12-08', 1),
(96, 30, 'user_id', '2015-12-14', 1),
(97, 30, 'block_user_id', '2015-12-14', 1),
(98, 31, 'post_id', '2015-12-14', 1),
(99, 31, 'user_id', '2015-12-14', 1),
(100, 31, 'block_user_id', '2015-12-14', 1),
(101, 32, 'post_id', '2015-12-14', 1),
(102, 32, 'comment_id', '2015-12-14', 1),
(103, 32, 'user_id', '2015-12-14', 1);
...
(0, 13, 62, '2015-11-19', 1),
(0, 13, 72, '2015-12-03', 2),
(0, 14, 99, '2015-12-15', 1),
(0, 14, 101, '2015-12-15', 2);

-- --------------------------------------------------------

--
-- Table structure for table `dostums_donate`
--

CREATE TABLE IF NOT EXISTS `dostums_donate` (
  `id` int(11) NOT NULL,
  `why_donation` varchar(255) DEFAULT NULL,
  `Select_money_symbol` varchar(200) DEFAULT NULL,
  `amount_pay` int(20) DEFAULT NULL,
  ...
  `select_home` varchar(20) DEFAULT NULL,
  `name_on_card` varchar(50) DEFAULT NULL,
  `card_number` int(20) DEFAULT NULL,
  `month` varchar(200) DEFAULT NULL,
  `select_year` int(20) DEFAULT NULL,
  `group_type` varchar(200) DEFAULT NULL,
  `group_or_business_name` varchar(255) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `status` int(2) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `dostums_donate`
--

INSERT INTO `dostums_donate` (`id`, `why_donation`, `Select_money_symbol`, `amount_pay`, `first_name`, `last_name`, `address`, `city_town`, `select_city`, `email_address`, `personal`, `phone_number`, `select_home`, `name_on_card`, `card_number`, `month`, `select_year`, `group_type`, `group_or_business_name`, `date`, `status`) VALUES
(1, '1', '4', 456, 'sssa', 'dddddd', 'ssd', 'dsss', 'Dhaka', 'assssss', 'Personal', 0, 'Home', 'sssss', 0, '01-january', 2015, '4', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', NULL, NULL),
(2, '1', '4', 456, 'sssa', 'dddddd', 'ssd', 'dsss', 'Dhaka', 'assssss', 'Personal', 0, 'Home', 'sssss', 0, '01-january', 2015, '4', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', NULL, NULL),
(3, '1', '4', 456, 'sssa', 'dddddd', 'ssd', 'dsss', 'Dhaka', 'assssss', 'Personal', 0, 'Home', 'sssss', 0, '01-january', 2015, '4', 'aaaaaaaaaaaaaaaaaaaaaaaaaaaa', NULL, NULL),
(4, 'Where Most Needed', '2', 450000, 'munira', 'moni', 'naogaon', 'naogaon', 'Dhaka', 'moniradiu@gmail.com', 'Personal', 1222235698, 'Home', 'debit', 2147483647, '01-january', 2015, '1', 'business', NULL, NULL),
(5, '', '1', 0, '', '', '', '', '', '', '', 0, '', '', 0, '', 0, '', '', NULL, NULL),
(6, '', '1', 0, '', '', '', '', '', '', '', 0, '', '', 0, '', 0, '', '', NULL, NULL),
(7, '', '1', 0, '', '', '', '', '', '', 'Personal', 0, 'Home', '', 0, '01-january', 2015, '', '', NULL, NULL),
(8, '', '1', 0, '', '', '', '', '', '', 'Personal', 0, 'Home', 'xzxzcxzc', 0, '01-january', 2015, '', '', NULL, NULL),
(9, '', '1', 0, '', '', '', '', '', '', 'Personal', 0, 'Home', 'xzxzcxzc', 0, '01-january', 2015, '', '', NULL, NULL),
(10, '', '2', 100, '', '', '', '', '', '', 'Personal', 0, 'Home', 'xzxzcxzc', 0, '01-january', 2015, '', '', NULL, NULL),
(11, 'Where Most Needed', '1', 0, '', '', '', '', 'Dhaka', '', 'Personal', 0, 'Home', '', 0, '01-january', 2015, '', '', NULL, NULL),
(12, '', '1', 0, '', '', '', '', '', '', 'Personal', 0, 'Home', '', 0, '01-january', 2015, '1', '', NULL, NULL),
(13, '2', '2', 122456, 'shanto', 'shant', 'dhaka', 'dhaka', 'Dhaka', 'shanto2gmail.com', 'Personal', 123456789, 'Home', 'credit', 12354789, '01-january', 2015, '', '', NULL, NULL),
(14, 'Where Most Needed', '1', 0, '', '', '', '', 'Dhaka', '', 'Personal', 0, 'Home', '', 0, '01-january', 2015, '', '', NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `dostums_fanpage` (
  ...
  `dostums_web_addr` varchar(255) NOT NULL,
  `color` text,
  `about` longtext,
  `mission` longtext,
  `vission` longtext,
...
--
-- Dumping data for table `dostums_fanpage`
--

INSERT INTO `dostums_fanpage` (`id`, `user_id`, `page_id`, `page_type_id`, `page_category`, `name`, `moto`, `email`, `phone`, `address`, `website`, `dostums_web_addr`, `color`, `about`, `mission`, `vission`, `date`, `status`) VALUES
(NULL, 13, 1449910735, 2, 'Computers/Technology', 'Systech Unimax Limited', NULL, NULL, NULL, NULL, 'http://systechunimax.com/', 'http://dostums.com/systechunimax', NULL, 'Systech Unimax is a custom software development and IT solutions company headquartered in Dhaka, Bangladesh powered with highly inspired, creative, talented and dedicated professionals who are willing to put their all strengths in pursuit of excellence. We are specialized in what we do and our software is coded the way you do business. We encourage creativity and innovation and make quality a value driver in our work, our products and our interactions.', NULL, NULL, '2015-12-12', 1),
(NULL, 13, 1449986291, 2, 'Cause', 'wrdfd', NULL, NULL, NULL, NULL, '', '', NULL, '', NULL, NULL, '2015-12-13', 1);

-- --------------------------------------------------------

--
-- Table structure for table `dostums_fanpage_category`
--

CREATE TABLE IF NOT EXISTS `dostums_fanpage_category` (
  `id` int(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `page_type_id` varchar(255) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `status` int(2) DEFAULT NULL
) ENGINE=InnoDB AUTO_INCREMENT=171 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `dostums_fanpage_category`
--

INSERT INTO `dostums_fanpage_category` (`id`, `name`, `page_type_id`, `date`, `status`) VALUES
(1, 'Airport', '1', '2015-12-08', 1),
(2, 'Arts/Entertainment/Nightlife', '1', '2015-12-08', 1),
(3, 'Attractions/Things to Do', '1', '2015-12-08', 1),
(4, 'Automotive', '1', '2015-12-08', 1),
(5, 'Bank/Financial Services', '1', '2015-12-08', 1),
(6, 'Bar', '1', '2015-12-08', 1),
(7, 'Book Store', '1', '2015-12-08', 1),
(8, 'Business Services', '1', '2015-12-08', 1),
(9, 'Church/Religious Organization', '1', '2015-12-08', 1),
(10, 'Club', '1', '2015-12-08', 1),
(11, 'Community/Government', '1', '2015-12-08', 1),
(12, 'Concert Venue', '1', '2015-12-08', 1),
(13, 'Doctor', '1', '2015-12-08', 1),
(14, 'Event Planning/Event Services', '1', '2015-12-08', 1),
(15, 'Food/Grocery', '1', '2015-12-08', 1),
(16, 'Health/Medical/Pharmacy', '1', '2015-12-08', 1),
(17, 'Home Improvement', '1', '2015-12-08', 1),
(18, 'Hospital/Clinic', '1', '2015-12-08', 1),
(19, 'Hotel', '1', '2015-12-08', 1),
(20, 'Landmark', '1', '2015-12-08', 1),
(21, 'Lawyer', '1', '2015-12-08', 1),
(22, 'Library', '1', '2015-12-08', 1),
(23, 'Local Business', '1', '2015-12-08', 1),
(24, 'Middle School', '1', '2015-12-08', 1),
(25, 'Movie Theater', '1', '2015-12-08', 1),
(26, 'Museum/Art Gallery', '1', '2015-12-08', 1),
(27, 'Outdoor Gear/Sporting Goods', '1', '2015-12-08', 1),
(28, 'Pet Services', '1', '2015-12-08', 1),
(29, 'Professional Services', '1', '2015-12-08', 1),
(30, 'Public Places', '1', '2015-12-08', 1),
(31, 'Real Estate', '1', '2015-12-08', 1),
(32, 'Restaurant/Cafe', '1', '2015-12-08', 1),
(33, 'School', '1', '2015-12-08', 1),
(34, 'Shopping/Retail', '1', '2015-12-08', 1),
(35, 'Spas/Beauty/Personal Care', '1', '2015-12-08', 1),
(36, 'Sports Venue', '1', '2015-12-08', 1),
(37, 'Sports/Recreation/Activities', '1', '2015-12-08', 1),
(38, 'Tours/Sightseeing', '1', '2015-12-08', 1),
(39, 'Transportation', '1', '2015-12-08', 1),
(40, 'University', '1', '2015-12-08', 1),
(41, 'Aerospace/Defense', '2', '2015-12-08', 1),
(42, 'Automobiles and Parts', '2', '2015-12-08', 1),
(43, 'Bank/Financial Institution', '2', '2015-12-08', 1),
(44, 'Biotechnology', '2', '2015-12-08', 1),
(45, 'Cause', '2', '2015-12-08', 1),
(46, 'Chemicals', '2', '2015-12-08', 1),
(47, 'Church/Religious Organization', '2', '2015-12-08', 1),
(48, 'Community Organization', '2', '2015-12-08', 1),
(49, 'Company', '2', '2015-12-08', 1),
(50, 'Computers/Technology', '2', '2015-12-08', 1),
(51, 'Consulting/Business Services', '2', '2015-12-08', 1),
(52, 'Education', '2', '2015-12-08', 1),
(53, 'Elementary School', '2', '2015-12-08', 1),
(54, 'Energy/Utility', '2', '2015-12-08', 1),
(55, 'Engineering/Construction', '2', '2015-12-08', 1),
(56, 'Farming/Agriculture', '2', '2015-12-08', 1),
(57, 'Food/Beverages', '2', '2015-12-08', 1),
(58, 'Government Organization', '2', '2015-12-08', 1),
(59, 'Health/Beauty', '2', '2015-12-08', 1),
(60, 'Health/Medical/Pharmaceuticals', '2', '2015-12-08', 1),
(61, 'Industrials', '2', '2015-12-08', 1),
(62, 'Insurance Company', '2', '2015-12-08', 1),
(63, 'Internet/Software', '2', '2015-12-08', 1),
(64, 'Legal/Law', '2', '2015-12-08', 1),
(65, 'Media/News/Publishing', '2', '2015-12-08', 1),
(66, 'Middle School', '2', '2015-12-08', 1),
(67, 'Mining/Materials', '2', '2015-12-08', 1),
(68, 'Non-Governmental Organization (NGO)', '2', '2015-12-08', 1),
(69, 'Non-Profit Organization', '2', '2015-12-08', 1),
(70, 'Organization', '2', '2015-12-08', 1),
(71, 'Political Organization', '2', '2015-12-08', 1),
(72, 'Political Party', '2', '2015-12-08', 1),
(73, 'Preschool', '2', '2015-12-08', 1),
(74, 'Retail and Consumer Merchandise', '2', '2015-12-08', 1),
(75, 'School', '2', '2015-12-08', 1),
(76, 'Small Business', '2', '2015-12-08', 1),
(77, 'Telecommunication', '2', '2015-12-08', 1),
(78, 'Transport/Freight', '2', '2015-12-08', 1),
(79, 'Travel/Leisure', '2', '2015-12-08', 1),
(80, 'University', '2', '2015-12-08', 1),
(81, 'App Page', '3', '2015-12-08', 1),
(82, 'Appliances', '3', '2015-12-08', 1),
(83, 'Baby Goods/Kids Goods', '3', '2015-12-08', 1),
(84, 'Bags/Luggage', '3', '2015-12-08', 1),
(85, 'Board Game', '3', '2015-12-08', 1),
(86, 'Building Materials', '3', '2015-12-08', 1),
(87, 'Camera/Photo', '3', '2015-12-08', 1),
(88, 'Cars', '3', '2015-12-08', 1),
(89, 'Clothing', '3', '2015-12-08', 1),
(90, 'Commercial Equipment', '3', '2015-12-08', 1),
(91, 'Computers', '3', '2015-12-08', 1),
(92, 'Drugs', '3', '2015-12-08', 1),
(93, 'Electronics', '3', '2015-12-08', 1),
(94, 'Food/Beverages', '3', '2015-12-08', 1),
(95, 'Furniture', '3', '2015-12-08', 1),
(96, 'Games/Toys', '3', '2015-12-08', 1),
(97, 'Health/Beauty', '3', '2015-12-08', 1),
(98, 'Home Decor', '3', '2015-12-08', 1),
(99, 'Household Supplies', '3', '2015-12-08', 1),
(100, 'Jewelry/Watches', '3', '2015-12-08', 1),
(101, 'Kitchen/Cooking', '3', '2015-12-08', 1),
(102, 'Office Supplies', '3', '2015-12-08', 1),
(103, 'Patio/Garden', '3', '2015-12-08', 1),
(104, 'Pet Supplies', '3', '2015-12-08', 1),
(105, 'Phone/Tablet', '3', '2015-12-08', 1),
(106, 'Product/Service', '3', '2015-12-08', 1),
(107, 'Software', '3', '2015-12-08', 1),
(108, 'Tools/Equipment', '3', '2015-12-08', 1),
(109, 'Video Game', '3', '2015-12-08', 1),
(110, 'Vitamins/Supplements', '3', '2015-12-08', 1),
(111, 'Website', '3', '2015-12-08', 1),
(112, 'Wine/Spirits', '3', '2015-12-08', 1),
(113, 'Actor/Director', '4', '2015-12-08', 1),
(114, 'Artist', '4', '2015-12-08', 1),
(115, 'Athlete', '4', '2015-12-08', 1),
(116, 'Author', '4', '2015-12-08', 1),
(117, 'Blogger', '4', '2015-12-08', 1),
(118, 'Business Person', '4', '2015-12-08', 1),
(119, 'Chef', '4', '2015-12-08', 1),
(120, 'Coach', '4', '2015-12-08', 1),
(121, 'Comedian', '4', '2015-12-08', 1),
(122, 'Dancer', '4', '2015-12-08', 1),
(123, 'Designer', '4', '2015-12-08', 1),
(124, 'Entertainer', '4', '2015-12-08', 1),
(125, 'Entrepreneur', '4', '2015-12-08', 1),
(126, 'Fictional Character', '4', '2015-12-08', 1),
(127, 'Government Official', '4', '2015-12-08', 1),
(128, 'Journalist', '4', '2015-12-08', 1),
(129, 'Movie Character', '4', '2015-12-08', 1),
(130, 'Musician/Band', '4', '2015-12-08', 1),
(131, 'News Personality', '4', '2015-12-08', 1),
(132, 'Pet', '4', '2015-12-08', 1),
(133, 'Photographer', '4', '2015-12-08', 1),
(134, 'Politician', '4', '2015-12-08', 1),
(135, 'Producer', '4', '2015-12-08', 1),
(136, 'Public Figure', '4', '2015-12-08', 1),
(137, 'Scientist', '4', '2015-12-08', 1),
(138, 'Teacher', '4', '2015-12-08', 1),
(139, 'Teacher', '4', '2015-12-08', 1),
(140, 'Writer', '4', '2015-12-08', 1),
(141, 'Album', '5', '2015-12-08', 1),
(142, 'Amateur Sports Team', '5', '2015-12-08', 1),
(143, 'Book', '5', '2015-12-08', 1),
(144, 'Book Series', '5', '2015-12-08', 1),
(145, 'Book Store', '5', '2015-12-08', 1),
(146, 'Concert Tour', '5', '2015-12-08', 1),
(147, 'Concert Venue', '5', '2015-12-08', 1),
(148, 'Fictional Character', '5', '2015-12-08', 1),
(149, 'Library', '5', '2015-12-08', 1),
(150, 'Magazine', '5', '2015-12-08', 1),
(151, 'Movie', '5', '2015-12-08', 1),
(152, 'Movie Character', '5', '2015-12-08', 1),
(153, 'Movie Theater', '5', '2015-12-08', 1),
(154, 'Music Award', '5', '2015-12-08', 1),
(155, 'Music Chart', '5', '2015-12-08', 1),
(156, 'Music Video', '5', '2015-12-08', 1),
(157, 'Performance Art', '5', '2015-12-08', 1),
(158, 'Radio Station', '5', '2015-12-08', 1),
(159, 'Record Label', '5', '2015-12-08', 1),
(160, 'School Sports Team', '5', '2015-12-08', 1),
(161, 'Song', '5', '2015-12-08', 1),
(162, 'Sports League', '5', '2015-12-08', 1),
(163, 'Sports Team', '5', '2015-12-08', 1),
(164, 'Sports Venue', '5', '2015-12-08', 1),
(165, 'Studio', '5', '2015-12-08', 1),
(166, 'Theatrical Play', '5', '2015-12-08', 1),
(167, 'TV Channel', '5', '2015-12-08', 1),
(168, 'TV Network', '5', '2015-12-08', 1),
(169, 'TV Show', '5', '2015-12-08', 1),
(170, 'TV/Movie Award', '5', '2015-12-08', 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `dostums_fanpage_category_view`
--
CREATE TABLE IF NOT EXISTS `dostums_fanpage_category_view` (
`id` int(20)
,`name` varchar(255)
,`page_type_id` varchar(255)
,`date` date
,`status` int(2)
);
...
--
-- Table structure for table `dostums_fanpage_type`
--

CREATE TABLE IF NOT EXISTS `dostums_fanpage_type` (
  `id` int(20) NOT NULL,
  `name` varchar(255) DEFAULT NULL,
  `date` date DEFAULT NULL,
  `status` int(2) DEFAULT NULL
...
--
-- Dumping data for table `dostums_fanpage_type`
--

INSERT INTO `dostums_fanpage_type` (`id`, `name`, `date`, `status`) VALUES
(1, 'Local Business or Place', '2015-12-08', 1),
(2, 'Company, Oraganization or Institution', '2015-12-08', 1),
(3, 'Brand or Product', '2015-12-08', 1),
(4, 'Artist,Band or Public Figure', '2015-12-08', 1),
(5, 'Media or Entertainment', '2015-12-08', 1),
(6, ' Cause or Community', '2015-12-08', 1);

-- --------------------------------------------------------

--
-- Stand-in structure for view `dostums_fanpage_type_view`
--
CREATE TABLE IF NOT EXISTS `dostums_fanpage_type_view` (
`id` int(20)
,`name` varchar(255)
,`date` date
,`status` int(2)
...
(10, 13, 1449049433, '', 0, 1, '', '', '', '', '', '', '', '', '', '2015-12-02', 1),
(11, 13, 1449049433, '', 0, 1, '', '', '', '', '', '', '', '', '', '2015-12-02', 1),
(12, 13, 1449130061, 'ffg', 60, 1, '', 'jjjj', 'hjhj', 'hjhj', 'hjhjhj', '', 'uyhjhj', '', '', '2015-12-03', 1),
(13, 13, 1449130728, '', 2, 1, '', 'jgf', 'jkjk', 'hngkjk', 'kjkjj', '', 'gfgfgf', '', '', '2015-12-03', 1),
(14, 13, 1449906609, 'df', 2, 1, '', 'fhgjkluuyh', 'sfggfhggjgjg', 'sgfdgf', 'srrfgfgrgrwrdss', '', 'dfdsffdg', '', '', '2015-12-12', 1);
...
(8, 13, 1, 69, '2015-11-24', 1),
(9, 13, 1448968777, 70, '2015-12-01', 2),
(10, 13, 1, 74, '2015-12-12', 2),
(11, 13, 1449902736, 75, '2015-12-12', 1),
(12, 13, 1449902736, 77, '2015-12-12', 1),
(13, 13, 1449902736, 79, '2015-12-12', 1),
(14, 13, 1449902736, 81, '2015-12-12', 2),
(15, 13, 1449906609, 84, '2015-12-12', 2),
(16, 13, NULL, 87, '2015-12-12', 2);
...
(9, 13, 1, 68, '2015-11-24', 1),
(10, 13, 1448968777, 71, '2015-12-01', 2),
(11, 13, 1, 73, '2015-12-12', 2),
(12, 13, 1449902736, 76, '2015-12-12', 1),
(13, 13, 1449902736, 78, '2015-12-12', 1),
(14, 13, 1449902736, 80, '2015-12-12', 1),
(15, 13, 1449902736, 82, '2015-12-12', 2),
(16, 13, 1449906609, 83, '2015-12-12', 2),
(17, 13, 1449905994, 85, '2015-12-12', 2),
(18, 13, 1449907354, 86, '2015-12-12', 2),
(19, 13, NULL, 88, '2015-12-12', 2);
...
(201, 13, NULL, '2015-12-03 08:27:10', '2015-12-03', 1),
(202, 13, NULL, '2015-12-03 08:27:24', '2015-12-03', 1),
(203, 13, NULL, '2015-12-03 08:27:25', '2015-12-03', 1),
(204, 13, 207, '2015-12-03 08:27:47', '2015-12-03', 1);
...
(277, 13, 13, 13, 13, 'hi this is shanto', 0, '2015-12-12 06:41:23', '2015-12-12', 1),
(278, 13, 13, 13, 13, 'hi this is shanto', 1, '2015-12-12 06:41:23', '2015-12-12', 2),
(279, 13, 13, 13, 13, 'ok', 0, '2015-12-19 11:33:33', '2015-12-19', 1),
(280, 13, 13, 13, 13, 'ok', 1, '2015-12-19 11:33:33', '2015-12-19', 2);
...
--
-- Dumping data for table `dostums_page_cover_photo`
--

INSERT INTO `dostums_page_cover_photo` (`id`, `user_id`, `page_id`, `photo_id`, `date`, `status`) VALUES
(1, 13, 1449910735, 95, '2015-12-12', 2);
...
--
-- Dumping data for table `dostums_page_profile_photo`
--

INSERT INTO `dostums_page_profile_photo` (`id`, `user_id`, `page_id`, `photo_id`, `date`, `status`) VALUES
(1, 13, 1449910735, 97, '2015-12-12', 2);
...
(72, 'cover1449131149.jpg', '565ffc8dcfbb6.jpeg', NULL, NULL, 1),
(73, 'group_profile1449899605.png', '566bb654f2e15.png', NULL, NULL, 1),
(74, 'group_cover1449899878.png', '566bb766da2b8.png', NULL, NULL, 1),
(75, 'group_cover1449903415.png', '566bc537ad12f.png', NULL, NULL, 1),
(76, 'group_profile1449903431.png', '566bc5473fffa.png', NULL, NULL, 1),
(77, 'group_cover1449904021.png', '566bc795a9700.png', NULL, NULL, 1),
(78, 'group_profile1449904029.png', '566bc79d2cedd.png', NULL, NULL, 1),
(79, 'group_cover1449904340.png', '566bc8d47c377.png', NULL, NULL, 1),
(80, 'group_profile1449904346.png', '566bc8dac32f8.png', NULL, NULL, 1),
(81, 'group_cover1449904706.png', '566bca4263a04.png', NULL, NULL, 1),
(82, 'group_profile1449904711.png', '566bca4722ca8.png', NULL, NULL, 1),
(83, 'group_profile1449906649.png', '566bd1d92811e.png', NULL, NULL, 1),
(84, 'group_cover1449906657.png', '566bd1e1d1617.png', NULL, NULL, 1),
(85, 'group_profile1449906937.png', '566bd2f94a82d.png', NULL, NULL, 1),
(86, 'group_profile1449907382.png', '566bd4b63265f.png', NULL, NULL, 1),
(87, 'group_cover1449910482.png', '566be0d268abf.png', NULL, NULL, 1),
(88, 'group_profile1449910487.png', '566be0d7d17b0.png', NULL, NULL, 1),
(89, 'page_cover1449910808.jpg', '566be218d4e68.jpeg', NULL, NULL, 1),
(90, 'page_profile1449910816.png', '566be220aaf7a.png', NULL, NULL, 1),
(91, 'page_cover1449910921.jpg', '566be289b94a6.jpeg', NULL, NULL, 1),
(92, 'page_profile1449910927.png', '566be28f6e960.png', NULL, NULL, 1),
(93, 'page_cover1449911024.png', '566be2f0567c2.png', NULL, NULL, 1),
(94, 'page_cover1449911100.jpg', '566be33ca22c3.jpeg', NULL, NULL, 1),
(95, 'page_cover1449911129.jpg', '566be35931465.jpeg', NULL, NULL, 1),
(96, 'page_profile1449911133.png', '566be35dad989.png', NULL, NULL, 1),
(97, 'page_profile1449911188.png', '566be394835ef.png', NULL, NULL, 1),
(98, 'status1450091629.jpg', '566ea46d78dd8.jpeg', NULL, NULL, 1),
(99, 'cover1450159967.jpg', '566faf5f91750.jpeg', NULL, NULL, 1),
(100, 'profile1450159991.jpg', '566faf77ed2a9.jpeg', NULL, NULL, 1),
(101, 'cover1450160013.jpg', '566faf8d57a9f.jpeg', NULL, NULL, 1);
...
(207, 13, NULL, 0, '  Changed Cover Photo ', 72, NULL, 0, '2015-12-03 03:25:50', '2015-12-03', 2),
(208, 13, 13, 0, '  Changed Cover Photo ', 72, 1, 0, '2015-12-08 10:13:48', '2015-12-08', 1),
(209, 13, NULL, 0, '  Changed Profile Photo ', 73, NULL, 0, '2015-12-12 00:53:25', '2015-12-12', 60),
(210, 13, NULL, 0, '  Changed Cover Photo ', 74, NULL, 0, '2015-12-12 00:57:59', '2015-12-12', 61),
(211, 13, NULL, 0, '  Changed Cover Photo ', 75, NULL, 0, '2015-12-12 01:56:55', '2015-12-12', 61),
(212, 13, NULL, 0, '  Changed Profile Photo ', 76, NULL, 0, '2015-12-12 01:57:11', '2015-12-12', 60),
(213, 13, NULL, 0, '  Changed Cover Photo ', 77, NULL, 0, '2015-12-12 02:07:01', '2015-12-12', 61),
(214, 13, NULL, 0, '  Changed Profile Photo ', 78, NULL, 0, '2015-12-12 02:07:09', '2015-12-12', 60),
(215, 13, NULL, 0, '  Changed Cover Photo ', 79, NULL, 0, '2015-12-12 02:12:20', '2015-12-12', 61),
(216, 13, NULL, 0, '  Changed Profile Photo ', 80, NULL, 0, '2015-12-12 02:12:26', '2015-12-12', 60),
(217, 13, NULL, 0, '  Changed Cover Photo ', 81, NULL, 0, '2015-12-12 02:18:26', '2015-12-12', 61),
(218, 13, NULL, 0, '  Changed Profile Photo ', 82, NULL, 0, '2015-12-12 02:18:31', '2015-12-12', 60),
(219, 13, NULL, 0, '  Changed Profile Photo ', 83, NULL, 0, '2015-12-12 02:50:49', '2015-12-12', 60),
(220, 13, NULL, 0, '  Changed Cover Photo ', 84, NULL, 0, '2015-12-12 02:50:57', '2015-12-12', 61),
(221, 13, NULL, 0, '  Changed Profile Photo ', 85, NULL, 0, '2015-12-12 02:55:37', '2015-12-12', 60),
(222, 13, NULL, 0, '  Changed Profile Photo ', 86, NULL, 0, '2015-12-12 03:03:02', '2015-12-12', 60),
(223, 13, NULL, 0, '  Changed Cover Photo ', 87, NULL, 0, '2015-12-12 03:54:42', '2015-12-12', 61),
(224, 13, NULL, 0, '  Changed Profile Photo ', 88, NULL, 0, '2015-12-12 03:54:47', '2015-12-12', 60),
(225, 13, NULL, 0, '  Changed Cover Photo ', 89, NULL, 0, '2015-12-12 04:00:09', '2015-12-12', 61),
(226, 13, NULL, 0, '  Changed Profile Photo ', 90, NULL, 0, '2015-12-12 04:00:16', '2015-12-12', 60),
(227, 13, NULL, 0, '  Changed Cover Photo ', 91, NULL, 0, '2015-12-12 04:02:02', '2015-12-12', 61),
(228, 13, NULL, 0, '  Changed Profile Photo ', 92, NULL, 0, '2015-12-12 04:02:07', '2015-12-12', 60),
(229, 13, NULL, 0, '  Changed Cover Photo ', 93, NULL, 0, '2015-12-12 04:03:44', '2015-12-12', 61),
(230, 13, NULL, 0, '  Changed Cover Photo ', 94, NULL, 0, '2015-12-12 04:05:00', '2015-12-12', 61),
(231, 13, NULL, 0, '  Changed Cover Photo ', 95, NULL, 0, '2015-12-12 04:05:29', '2015-12-12', 61),
(232, 13, NULL, 0, '  Changed Profile Photo ', 96, NULL, 0, '2015-12-12 04:05:33', '2015-12-12', 60),
(233, 13, NULL, 0, '  Changed Profile Photo ', 97, NULL, 0, '2015-12-12 04:06:28', '2015-12-12', 60),
(234, 13, 13, 0, '', 0, 0, 0, '2015-12-13 11:17:18', '2015-12-13', 1),
(235, 13, NULL, 0, '', 98, NULL, 0, '2015-12-14 06:13:49', '2015-12-14', 3),
(236, 13, 13, 0, '', 98, 1, 0, '2015-12-14 11:14:07', '2015-12-14', 1),
(237, 14, NULL, 0, '  Changed Cover Photo ', 99, NULL, 0, '2015-12-15 01:12:47', '2015-12-15', 2),
(238, 14, NULL, 0, '  Changed Profile Photo ', 100, NULL, 0, '2015-12-15 01:13:12', '2015-12-15', 2),
(239, 14, NULL, 0, '  Changed Cover Photo ', 101, NULL, 0, '2015-12-15 01:13:33', '2015-12-15', 2);
...
(129, 13, 207, NULL, '2015-12-03', 1),
(130, 13, 0, 1, '2015-12-03', 1),
(131, 13, 209, NULL, '2015-12-10', 1),
(132, 13, 0, 20, '2015-12-10', 1),
(133, 13, 0, 20, '2015-12-10', 1),
(134, 13, 209, NULL, '2015-12-12', 1),
(135, 13, 210, NULL, '2015-12-12', 1),
(136, 13, 211, NULL, '2015-12-12', 1),
(137, 13, 212, NULL, '2015-12-12', 1),
(138, 13, 213, NULL, '2015-12-12', 1),
(139, 13, 214, NULL, '2015-12-12', 1),
(140, 13, 215, NULL, '2015-12-12', 1),
(141, 13, 216, NULL, '2015-12-12', 1),
(142, 13, 217, NULL, '2015-12-12', 1),
(143, 13, 218, NULL, '2015-12-12', 1),
(144, 13, 219, NULL, '2015-12-12', 1),
(145, 13, 220, NULL, '2015-12-12', 1),
(146, 13, 221, NULL, '2015-12-12', 1),
(147, 13, 222, NULL, '2015-12-12', 1),
(148, 13, 223, NULL, '2015-12-12', 1),
(149, 13, 224, NULL, '2015-12-12', 1),
(150, 13, 225, NULL, '2015-12-12', 1),
(151, 13, 226, NULL, '2015-12-12', 1),
(152, 13, 227, NULL, '2015-12-12', 1),
(153, 13, 228, NULL, '2015-12-12', 1),
(154, 13, 229, NULL, '2015-12-12', 1),
(155, 13, 230, NULL, '2015-12-12', 1),
(156, 13, 231, NULL, '2015-12-12', 1),
(157, 13, 232, NULL, '2015-12-12', 1),
(158, 13, 233, NULL, '2015-12-12', 1),
(159, 13, 234, NULL, '2015-12-13', 1),
(160, 13, 0, 20, '2015-12-13', 1),
(161, 13, 0, 20, '2015-12-14', 1),
(162, 13, 235, 20, '2015-12-14', 1),
(163, 14, 237, NULL, '2015-12-15', 1),
(164, 14, 238, NULL, '2015-12-15', 1),
(165, 14, 239, NULL, '2015-12-15', 1),
(166, 13, 0, 20, '2015-12-19', 1),
(167, 13, 0, 20, '2015-12-19', 1);
...
(96, 13, 207, 1, '2015-12-03', 1),
(97, 13, 209, 1, '2015-12-10', 1),
(98, 13, 209, 1, '2015-12-12', 1),
(99, 13, 210, 1, '2015-12-12', 1),
(100, 13, 211, 1, '2015-12-12', 1),
(101, 13, 212, 1, '2015-12-12', 1),
(102, 13, 213, 1, '2015-12-12', 1),
(103, 13, 214, 1, '2015-12-12', 1),
(104, 13, 215, 1, '2015-12-12', 1),
(105, 13, 216, 1, '2015-12-12', 1),
(106, 13, 217, 1, '2015-12-12', 1),
(107, 13, 218, 1, '2015-12-12', 1),
(108, 13, 219, 1, '2015-12-12', 1),
(109, 13, 220, 1, '2015-12-12', 1),
(110, 13, 221, 1, '2015-12-12', 1),
(111, 13, 222, 1, '2015-12-12', 1),
(112, 13, 223, 1, '2015-12-12', 1),
(113, 13, 224, 1, '2015-12-12', 1),
(114, 13, 225, 1, '2015-12-12', 1),
(115, 13, 226, 1, '2015-12-12', 1),
(116, 13, 227, 1, '2015-12-12', 1),
(117, 13, 228, 1, '2015-12-12', 1),
(118, 13, 229, 1, '2015-12-12', 1),
(119, 13, 230, 1, '2015-12-12', 1),
(120, 13, 231, 1, '2015-12-12', 1),
(121, 13, 232, 1, '2015-12-12', 1),
(122, 13, 233, 1, '2015-12-12', 1),
(123, 13, 234, 1, '2015-12-13', 1),
(124, 13, 235, 1, '2015-12-14', 1),
(125, 14, 237, 1, '2015-12-15', 1),
(126, 14, 238, 1, '2015-12-15', 1),
(127, 14, 239, 1, '2015-12-15', 1);
...
(9, 13, 13, 207, '2015-12-08 10:13:48', '2015-12-08', 1),
(10, 13, 13, 235, '2015-12-14 11:14:06', '2015-12-14', 1);
...
(4, 'tasnim', 'shadrita', NULL, NULL, 0, '', 'ritashad@gmail.com', '7e8a32176a113a7ba3d2b1f85834e828', NULL, NULL, NULL, NULL, '6666', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'munira-PC', '2015-12-12', 1, 2),
(5, 'Ifshita', 'tasnim', NULL, NULL, 0, '', 'ifshita23@yahoo.com', '7e8a32176a113a7ba3d2b1f85834e828', NULL, NULL, NULL, NULL, '6541', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'munira-PC', '2015-12-12', 1, 1),
...
(13, 'shanto', '', NULL, NULL, 0, '', 'sk.bd2007@gmail.com', 'c199f5a4e53ff346e22f1183974943c9', NULL, NULL, NULL, NULL, 'asdf1234', '', NULL, NULL, 20, 'Dhaka', NULL, NULL, NULL, 'SUL-LABPC-11', '2015-12-12', 1, 1),
(14, 'sirajum', 'munira', NULL, NULL, NULL, NULL, 'moniradiu@gmail.com', '7e8a32176a113a7ba3d2b1f85834e828', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'USER-PC-Monira', '2015-12-15', 1, 1);
...
(13, 13, 1, '', '2015-12-17', 1),
(14, 13, 2, '', '2015-12-17', 1);
...
(27, 'dostums_fanpage_type', 'dostums_fanpage_type.php', '', 'Dostums Fanpage Type', '2015-12-08', 1),
(29, 'dostums_fanpage_category', 'dostums_fanpage_category.php', '', 'Dostums Fanpage Category', '2015-12-08', 1),
(30, 'block_friend_user', 'block_friend_user.php', '', 'Block Friend user', '2015-12-14', 1),
(31, 'block_post_user', 'block_post_user.php', '', 'Block Post User', '2015-12-14', 1),
(32, 'block_post_comment', 'block_post_comment.php', '', 'Block Post Comment', '2015-12-14', 1);
...
--
-- Structure for view `block_friend_user_view`
--
DROP TABLE IF EXISTS `block_friend_user_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `block_friend_user_view` AS select `block_friend_user`.`id` AS `id`,`block_friend_user`.`user_id` AS `user_id`,`block_friend_user`.`block_user_id` AS `block_user_id`,`block_friend_user`.`date` AS `date`,`block_friend_user`.`status` AS `status` from `block_friend_user`;

-- --------------------------------------------------------

--
-- Structure for view `block_post_comment_view`
--
DROP TABLE IF EXISTS `block_post_comment_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `block_post_comment_view` AS select `block_post_comment`.`id` AS `id`,`block_post_comment`.`post_id` AS `post_id`,`block_post_comment`.`comment_id` AS `comment_id`,`block_post_comment`.`user_id` AS `user_id`,`block_post_comment`.`date` AS `date`,`block_post_comment`.`status` AS `status` from `block_post_comment`;

-- --------------------------------------------------------

--
-- Structure for view `block_post_user_view`
--
DROP TABLE IF EXISTS `block_post_user_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `block_post_user_view` AS select `block_post_user`.`id` AS `id`,`block_post_user`.`post_id` AS `post_id`,`block_post_user`.`user_id` AS `user_id`,`block_post_user`.`block_user_id` AS `block_user_id`,`block_post_user`.`date` AS `date`,`block_post_user`.`status` AS `status` from `block_post_user`;
...
--
-- Structure for view `dostums_fanpage_category_view`
--
DROP TABLE IF EXISTS `dostums_fanpage_category_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `dostums_fanpage_category_view` AS select `dostums_fanpage_category`.`id` AS `id`,`dostums_fanpage_category`.`name` AS `name`,`dostums_fanpage_category`.`page_type_id` AS `page_type_id`,`dostums_fanpage_category`.`date` AS `date`,`dostums_fanpage_category`.`status` AS `status` from `dostums_fanpage_category`;

-- --------------------------------------------------------

--
-- Structure for view `dostums_fanpage_type_view`
--
DROP TABLE IF EXISTS `dostums_fanpage_type_view`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `dostums_fanpage_type_view` AS select `dostums_fanpage_type`.`id` AS `id`,`dostums_fanpage_type`.`name` AS `name`,`dostums_fanpage_type`.`date` AS `date`,`dostums_fanpage_type`.`status` AS `status` from `dostums_fanpage_type`;
...
--
-- Indexes for table `block_friend_user`
--
ALTER TABLE `block_friend_user`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `block_post_comment`
--
ALTER TABLE `block_post_comment`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `block_post_user`
--
ALTER TABLE `block_post_user`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `dostums_donate`
--
ALTER TABLE `dostums_donate`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dostums_fanpage_category`
--
ALTER TABLE `dostums_fanpage_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `dostums_fanpage_type`
--
ALTER TABLE `dostums_fanpage_type`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `block_friend_user`
--
ALTER TABLE `block_friend_user`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `block_post_comment`
--
ALTER TABLE `block_post_comment`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `block_post_user`
--
ALTER TABLE `block_post_user`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
--
-- AUTO_INCREMENT for table `dostums_donate`
--
ALTER TABLE `dostums_donate`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `dostums_fanpage_category`
--
ALTER TABLE `dostums_fanpage_category`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=171;
--
-- AUTO_INCREMENT for table `dostums_fanpage_type`
--
ALTER TABLE `dostums_fanpage_type`
...
--
ALTER TABLE `dostums_post`
  MODIFY `id` int(20) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=240;
--
