                                                ...
                                                $sqlphoto = $obj->FlyQuery("SELECT allgroup_photo.*,p.photo,p.id FROM 
                                                                            (select A.p_id, A.pp_id, A.cp_id, 
                                                                             ...
                                                                             (
                                                                                     ...
                                                                                     dppp.photo_id as pp_id, dpcp.photo_id as cp_id
                                                                                     from  dostums_post as dp 
                                                                                     left join dostums_page_profile_photo  as dppp on dp.photo_id = dppp.photo_id
                                                                                     left join dostums_page_cover_photo as dpcp on dp.photo_id = dpcp.photo_id 
                                                                                     where dp.page_id='".$new_page_id."' and (dp.status = 120 or dp.status = 121 or dp.status = 122)  and dp.photo_id != 0 AND dp.group_id='0') A
                                                                            ) as allgroup_photo 
