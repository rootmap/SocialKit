!function (a) {
    ...
    a.expr[":"].notmdproc = function (b) {
        ...
        options: {
            ...
            arrive: !0,
            autofill: !1,
            withRipples: [".btn:not(.btn-link)", ".card-image", ".navbar a:not(.withoutripple)", ".dropdown-menu a", ".nav-tabs a:not(.withoutripple)", ".withripple", ".pagination li:not(.active, .disabled) a:not(.withoutripple)"].join(","),
            ...
            a(c ? c : this.options.inputElements).filter(":notmdproc").data("mdproc", !0).each(function () {
                ...
                var b = a(this);
                "" !== b.val() || "undefined" == typeof b[0].checkValidity || b[0].checkValidity() ? b.removeClass("empty") : b.addClass("empty")
