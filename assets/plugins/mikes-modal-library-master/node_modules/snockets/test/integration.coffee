...
testSuite =
  ...
  'require_tree works for nested directories': (test) ->
    snockets.scan 'fellowship.js', (err) ->
      ...
      test.deepEqual chain, ['middleEarth/legolas.coffee', 'middleEarth/shire/bilbo.js',
  ...
  'require_tree works for redundant directories': (test) ->
    snockets.scan 'trilogy.coffee', (err) ->
      ...
      test.deepEqual chain, ['middleEarth/shire/bilbo.js', 'middleEarth/shire/frodo.coffee',
