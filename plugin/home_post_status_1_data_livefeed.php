...
$livefeedpost_id = $_SESSION['post_id'];
...
$results = $obj->FlyQueryWithLimit("SELECT
         ...
         (dp.user_id IN  (
          ...
          ) AND (dp.status = '1' OR dp.status = '2' OR dp.status = '3' OR dp.status = '4') AND dp.id='$livefeedpost_id' ORDER BY dp.id DESC LIMIT :start, :end
