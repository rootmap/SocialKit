    ...
    (function ($) {
        ...
        $.fn.loaddata = function (options) {
            ...
            var settings = $.extend({
                ...
                data_url: './plugin/home_post_status_1_data_liveFeed.php', //url to PHP page
        ...
        function contents(el, settings) {
            var load_img = $('<img/>').attr('src', settings.loading_gif_url).addClass('loading-image').css("margin-left", "35%");
            ; //create load image
