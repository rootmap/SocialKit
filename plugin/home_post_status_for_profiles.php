...
// echo $dostums_user_id;
// echo $new_user_id;



$checkUser = $obj->FlyQuery("SELECT
COUNT(df.id) AS friend
FROM dostums_friend AS df

WHERE ((df.uid = '".$dostums_user_id."' AND df.to_uid = '".$new_user_id."')
         OR
       (df.uid = '".$new_user_id."' AND df.to_uid = '".$dostums_user_id."'))
AND df.status = '2'");

if($checkUser[0]->friend == '1'){
  // echo "friend";

  $for_friend = $obj->FlyQuery("SELECT
  dp.id AS postID,
...
(
    (
       dp.user_id = '".$new_user_id."'
    	 AND
    	 (dp.status = '1' OR dp.status = '2' OR dp.status = '3' OR dp.status = '4')
    )
...
) AND (dp.post_permission = '1' OR dp.post_permission = '2')
ORDER BY dp.id DESC
...
#                WHERE (
#                        (a.to_user_id = '20' AND a.post_status = '2')
#                         AND a.status = '2'
#                      )
#                      OR
#                      (
#                        (a.from_user_id = '20' AND a.post_status = '1')
#                         AND a.status = '2'
#                      )
#              )
");
                            ...
                            <div class="panel-body">
                                 ...
                                 if($shareID != '0'){
                                            ...
                                            <div class="row">
                                              ...
                                              <div class="col-md-10 col-xs-10">
                                                  <h5>
                                                    ...
                                                    <span style="color:#777;"> <span><?php echo $sdate;?></span> - <?php if($postPermission == '1')
                                                                               {
                                                                                 echo '<i class="fa fa-globe" aria-hidden="true"></i>';
                                                                               }
                                                                               else if($postPermission == '2')
                                    ...
                                    <?php
                                        ...
                                        echo "Shere data problem in load.";
                                    }
                                 }
