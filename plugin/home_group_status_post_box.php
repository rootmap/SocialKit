<form class="facebook-share-box" enctype="multipart/form-data" role="form" method="post" action="#">
    <div class="share">
        ...
        <div class="panel panel-default panel-customs-post  panel-status">
            <div class="panel-heading">
                ...
                <ul class="post-types list-unstyled list-inline">
                    ...
                    <li class="post-type">
                        <button style="color:#333; font-size:14px;" class="photos def_button"  type="button" id="uploadGroupImage"><i class="fa fa-camera"></i> Add photos</button>
                    </li>
                    <li class="post-type">
                ...
                <div class="fileUpload" style="float:left;">
                    ...
                    <input type="file" id="uploadGroupStatusImage" class="upload" />
                </div>	
                <script type="text/javascript">
                    ...
                    $(window).load(function () {
                        ...
                        //status
                        $('#uploadGroupStatusImage').on('change', function () {
                            ...
                            reader.onload = function (e) {
                                ...
                                $('#group_post_button').html("<input onclick='UploadGroupImageString(" + n + ")' type='button' id='btnGroupImagePostStatus' class='btn btn-post btn-info pull-right no-margin' value='Post' name='submit'>");
                        ...
                        //status end
                        <?php if (in_array($obj->filename(), array("group.php"))) { ?>
                            $('#file_cover').on('change', function () {
                                ...
                                reader.onload = function (e) {
                                    ...
                                    post_data = {'img': img, 'st': 6, 'group_id':<?php echo $new_group_id; ?>};
                                    $.post('lib/image.php', post_data, function (datas) {
                                        alert("Done.");
                                    });
                            ...
                            $('#file').on('change', function () {
                                ...
                                reader.onload = function (e) {
                                    ...
                                    var img = e.target.result;
                                    post_data = {'img': img, 'st': 5, 'group_id':<?php echo $new_group_id; ?>};
                                    $.post('lib/image.php', post_data, function (datas) {
        ...
        <?php } elseif (in_array($obj->filename(), array("page.php"))) { ?>
                            $('#file_cover').on('change', function () {
                                var reader = new FileReader();
                                reader.onload = function (e) {
                                    options.imgSrc = e.target.result;
                            ...
                            $('#file').on('change', function () {
                                ...
                                reader.onload = function (e) {
                                    ...
                                    var img = e.target.result;
                                    post_data = {'img': img, 'st': 11, 'page_id':<?php echo $new_page_id; ?>};
                                    $.post('lib/image.php', post_data, function (datas) {
                                        //window.location.assign("profile.php");
                                        //$('.cropped').append('<img src="'+img+'">');
                                        alert("Done.");
...
?>
            ...
            <div class="panel-body">
                <div class="status-contnent">
                    <textarea placeholder="What's on your mind ?" style="height: 62px; overflow: hidden;" class="form-control message" id="group_status_message" rows="10" cols="40" name="message"></textarea>
                    <input id="grp-id-postbox" type="hidden" value="<?php echo $new_group_id ?>"
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="row">
                            ...
                            <div class=" col-sm-6" id="group_post_button">
                                <input type="button" id="btnPostGroupStatus" class="btn btn-post btn-success pull-right no-margin" value="Post" name="submit">
                            </div>
