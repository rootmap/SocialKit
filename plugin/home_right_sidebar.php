            ...
            <div class="panel-body no-padding">
                ...
                <div id="carousel-example-generic" class="carousel slide carousel-notice"
                    ...
                    <div class="carousel-inner " role="listbox">
                        <?php
                        $sqlnoticebio = $obj->FlyQuery("SELECT * FROM dostums_bio_notice");
                        if (!empty($sqlnoticebio)) {
                            $i=1;
                            foreach ($sqlnoticebio as $bio):
                                ?>
                                <div class="item<?php if($i==1){ ?> active<?php } ?>">
                                    <a href="notice_bio_detail.php?notice=<?php echo $bio->id; ?>">
                                      <!-- <img  src="<?php echo $obj->baseurl("formula/upload/" . $bio->photo); ?>" alt="..."> -->
                                      <img style="height: 300px;" src="<?php echo $obj->baseurl("formula/upload/" . $bio->photo); ?>" alt="...">
                                    </a>

                                    <div class="carousel-caption">
                                        <h4> <?php echo $bio->name; ?></h4>

                                        <div class="sub-notice">
                                            <small><?php echo $bio->date_of_birth; ?><br>
                                                <?php echo $bio->date_of_dead; ?>
                                            </small>
                                            <div style="clear:both;"></div>
                                            <a target="_blank" href="notice_bio_detail.php?notice=<?php echo $bio->id; ?>" class="btn btn-danger btn-sm">View details </a>
                                        </div>
                                    </div>
                                </div>
                                <?php
                                    ...
                                    if ($s == 4) {
                                        ...
                                        <li class="news-item">
                                            <div class="news-item-inner">
                                                <a class="has-image-full" title="#" href="recent_notice_detail.php?notice=<?php echo $notice->id; ?>">

                                                    <div class="image ">
                                                        <img class="img-responsive"  src="<?php echo $obj->baseurl("formula/upload/" . $notice->notice_image); ?>">
                                                    </div>
                                        ...
                                        <li class="news-item ">
                                            <div class="news-item-inner">
                                                <a title="#" href="recent_notice_detail.php?notice=<?php echo $notice->id; ?>" class="has-only-text">
                                        ...
                                        <li class="news-item">
                                            <div class="news-item-inner">
                                                <a title="#" href="recent_notice_detail.php?notice=<?php echo $notice->id; ?>">
                                                    <i class="mdi-navigation-chevron-right arrow"></i>

                                                    <div class="image">
                                                        <img width="81" height="66" alt="#" src="<?php echo $obj->baseurl("formula/upload/" . $notice->notice_image); ?>">
                                                    </div>
                                                    <?php echo $notice->notice_title; ?>
                                                    <span class="info"><?php echo $notice->notice_date; ?></span>
                                                </a>
                                        ...
                                        <div>
                                            <div class="media">
                                                ...
                                                <div class="media-body ">
                                                    ...
                                                    <a style="font-weight:bold;" href="homeliveFeed.php?user_id=<?php echo $livefeed->user_id; ?>&postid=<?php echo $livefeed->id; ?>"><?php echo $obj->SelectAllByVal("dostums_user_view", "id", $livefeed->user_id, "name"); ?></a> <?php echo $obj->limit_words($livefeed->post, 5); ?>. <br>
