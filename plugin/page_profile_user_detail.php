<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <div class="panel-content profile-content">
            <h4><strong><?php echo $obj->SelectAllByVal("dostums_fanpage","page_id",$new_page_id,"name"); ?>  </strong></h4>

            <p><i class="fa  fa-clock-o "></i>&nbsp;Published &nbsp;:&nbsp;<?php echo substr($obj->SelectAllByVal("dostums_fanpage","page_id",$new_page_id,"date"),0,4); ?></p>

            <p><i class="fa fa-map-marker"></i>&nbsp;<?php echo $obj->SelectAllByVal("dostums_fanpage","page_id",$new_page_id,"address");?></p>
            <h5>
                <strong>About</strong>
            </h5>

            <p><?php echo $obj->SelectAllByVal("dostums_fanpage","page_id",$new_page_id,"about");?></p>
