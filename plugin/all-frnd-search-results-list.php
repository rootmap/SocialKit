...
<div class="panel ">
    <div class="panel-heading">
       <h3 class="panel-title">Your Search Result Matches with&nbsp;<span class="text-danger"><strong id="total_people">0</strong>&nbsp;People</span></h3>  
	</div>
				...
				$('document').ready(function() {
							...
							var search_string='<?php echo $_GET['result']; ?>';
								$.post("./lib/search_friends.php", {'st': 3,'search_data': search_string},function(fetchs){
									...
									var total_record=datacls.total_record;
									$('#friendlist_profile_l').html(opts);
									$('#total_people').html(total_record);
								});
